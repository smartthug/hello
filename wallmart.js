...
bars.addEventListener('click',()=>{
   bars.classList.toggle('pages');
   bars.classList.toggle('sign');
   bars.classList.toggle('list');
   if(bars.classList.toggle==false){
      document.querySelector('.third-header').style.display='none';
}
//else if(bars.classList.toggle==true){
//   document.querySelector('.third-header').style.display='flex'; 
//}
else{
   document.querySelector('.third-header').style.display='flex';  
}
